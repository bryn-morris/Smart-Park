...
with app.app_context():
    ...
    dp3 = Dog_Park(name = 'Dirt Bowl', address = "73 Dessert St, Phoenix, AZ, 98703", rating = 5, amenities = 'dust, cactus', image = 'https://images.unsplash.com/photo-1470208564179-dd5b52a0d010?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1262&q=80')
